...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShellWidget = React.createClass({
	    displayName: 'ShellWidget',

	    render: function () {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(ShellWidgetButton, { text: this.props.text, action: this.props.action }),
	            React.createElement(ShellWidgetOutput, null)
	        );
	    }
	});

	var ShellWidgetButton = React.createClass({
	    displayName: 'ShellWidgetButton',
	    ...
	    render: function () {
	        ...
	        return React.createElement(
	            'button',
	            { action: this.props.action, className: btnClass },
	            this.props.text
	        );
	    }
	});
	...
	var ShellWidgetOutput = React.createClass({
	    displayName: 'ShellWidgetOutput',

	    render: function () {
	        return React.createElement('pre', { className: 'debug' });
	    }
	});

	ReactDOM.render(React.createElement(ShellWidget, { text: 'Click Me', action: 'echo im in ur shell!' }), document.getElementById('secondTest'));

	ReactDOM.render(React.createElement(ShellWidget, { text: 'List Files', action: 'ls -la' }), document.getElementById('thirdTest'));
